...
class Trainer(Base):
    ...
    def _make_batch_generator(self):
        ...
        self.logger.info("Creating dataset..loaded smplx_param")
        self.flame_params = self.trainset_loader.flame_params
        self.logger.info("Creating dataset..loaded flame_param")
        self.flame_shape_param = self.trainset_loader.flame_shape_param
        self.logger.info("Creating dataset..loaded flame_shape_param")
