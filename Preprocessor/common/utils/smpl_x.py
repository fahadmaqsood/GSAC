...
class SMPLX(object):
    def __init__(self):
        ...
        self.layer_arg = {'create_global_orient': False, 'create_body_pose': False, 'create_left_hand_pose': False, 'create_right_hand_pose': False, 'create_jaw_pose': False, 'create_leye_pose': False, 'create_reye_pose': False, 'create_betas': False, 'create_expression': False, 'create_transl': False,
                          "use_pca" : False, "num_pca_comps":12}
        self.layer = smplx.create(cfg.human_model_path, 'smplx', gender=cfg.gender, num_betas=self.shape_param_dim, num_expression_coeffs=self.expr_param_dim,  use_face_contour=True, 
                                  **self.layer_arg
                                  )
    ...
    def get_expr_from_flame(self, smplx_layer):
        flame_layer = smplx.create(cfg.human_model_path, 'flame', gender=cfg.gender, num_betas=self.shape_param_dim, num_expression_coeffs=self.expr_param_dim)
