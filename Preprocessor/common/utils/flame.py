...
class FLAME(object):
    def __init__(self):
        ...
        self.layer = smplx.create(cfg.human_model_path, 'flame', gender=cfg.gender, num_betas=self.shape_param_dim, num_expression_coeffs=self.expr_param_dim, use_face_contour=True, **self.layer_arg)
