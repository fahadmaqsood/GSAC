...
class L1Loss(torch.nn.Module):
    def __init__(self, weight=1.):
        super().__init__()
        self._weight = weight
        self._loss_fn_l1 = torch.nn.L1Loss()
    ...
    def forward(self, data_dict, training_stage):
        ...
        if use_mask:
            ...
            loss = self._loss_fn_l1(gt_image * loss_mask, render_image * loss_mask) * self._weight
        else:
            loss = self._loss_fn_l1(gt_image, render_image) * self._weight
        return loss
